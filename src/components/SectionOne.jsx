...
const SectionOne = () => {
  ...
  return (
    <CommonMargin>
      <div className="flex justify-between w-full border-b-4 pb-20 animate-fade-right animate-ease-in-out animate-delay-[500ms] animate-duration-[2000ms]">
        ...
        <div className="flex flex-col justify-between flex-[0.2]">
          ...
          <button className="text-2xl font-semibold cursor-pointer animate-fade animate-delay-[1500ms] animate-thrice animate-ease-linear" onClick={()=>{window.scrollTo({ top: document.body.scrollHeight, behavior: "smooth" })}}>Scroll Down</button>
        </div>
      </div>
    </CommonMargin>
  );
