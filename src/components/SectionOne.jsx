      ...
      <div className="flex justify-between w-full border-b-4 pb-8 md:pb-20 animate-fade-right animate-ease-in-out animate-delay-[500ms] animate-duration-[2000ms]">
        <div className="flex-[0.7]">
          ...
          <div className="flex gap-5">
            ...
            {/* <button className="bg-gray-800 text-white px-6 rounded-full flex justify-between items-center text-2xl">
              <MdOutlineFileDownload />
              <span>Resume</span>
            </button> */}
          </div>
        </div>
        <div className="flex flex-col justify-between flex-[0.2] items-end">
          <div className="text-end lg:text-center animate-fade animate-ease-in-out animate-duration-[2000ms]">
            ...
            <a
              ...
              target="_blank"
              className="bg-gray-800 text-white px-6 py-2 rounded-full flex justify-between items-center text-2xl"
            >
              <MdOutlineFileDownload />
              <span>Resume</span>
            </a>
          ...
          <button
            className="text-2xl font-semibold cursor-pointer animate-fade animate-delay-[1500ms] animate-thrice animate-ease-linear flex items-center justify-end gap-2"
            onClick={() => {
              window.scrollTo({
