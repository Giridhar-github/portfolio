...
const SectionFour = () => {
  ...
  return (
    <CommonMargin>
      <div className="flex flex-col md:flex-row justify-between gap-10 border-b-3 border-gray-800 pb-10 animate-fade-right animate-delay-[1400ms] animate-ease-in-out animate-duration-[2000ms]">
